...
class LinkedinOAuthService extends EOAuthService {	
	...
	protected $scope = 'r_contactinfo r_emailaddress';
	...
	protected function fetchAttributes() {
		$info = $this->makeSignedRequest('http://api.linkedin.com/v1/people/~:(id,first-name,last-name,public-profile-url,email-address,phone-numbers)', array(), false); // json format not working :(
		...
		$this->attributes['service_id'] = 'linkedin_id';
